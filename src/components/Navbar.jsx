...
const Navbar = () => {
  return (
    <div className="div1 bg-[#EDE8D0] col-span-4 md:col-span-2 sm:col-span-1 flex items-center justify-between rounded-2xl p-3">
      <a className="text-black font-primary text-2xl">Md Rahbir Mahdi</a>
