...
const SpotlightCard = ({ children, className = "", spotlightColor = "rgba(185, 139, 115, 1)" }) => {
  ...
  return (
    <div
      ...
      className={`relative rounded-3xl border border-primary bg-primary overflow-hidden p-8 ${className}`}
    >
      <div
